...
class EconomicProfileRepositoryTest < Minitest::Test
  ...
  def test_can_make_an_instance_of_economic_profile
    ...
    assert_instance_of EconomicProfile, @economic_profile_repository.profile_generator(row)
  end
  ...
  def test_can_populate_median_house_hold_income
    ...
    assert_equal expected, @economic_profile_repository.median_profile_maker(row, "median_household_income")
  end
  ...
  def test_can_populate_children_in_poverty
    ...
    assert_equal expected, @economic_profile_repository.children_profile_maker(row, "children_in_poverty")
  end
